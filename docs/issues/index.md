...
| [0011](0011-osv-parse-extraction.md) | Extract pure osv-parse module; decompose scan + parsers (ADR 0014) | Open |
| [0012](0012-report-artifact-plan.md) | Artifact plan resolver; decompose runFixPipeline + fan-out (ADR 0015) | Open |
