---
type: Research
title: Advisor/fixer industry patterns — scan-to-fix relationship and config simplicity
description: How industry security tools (Snyk, osv-scanner, Dependabot, Renovate, npm audit) relate scan to fix, and what makes config simple for non-experts.
tags: [research, advisor, fixer, config]
